...
These fonts are each copyright (c) 2011 by S. John Ross. "Cumberland Games & Diversions" and the title of each font are trademarks of S. John Ross. These fonts are free for private use only. Any public or commercial use, or any use by an organization rather than an individual, requires a license; contact the Cumberland Fontworks via email (sjohn@cumberlandgames.com or sjohn@io.com) or find me on the Web for additional contact information. Additional glyphs (foreign alphabet support, customizations, etc) are available by commission.
